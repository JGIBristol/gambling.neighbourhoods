...
This vignette demonstrates how to create interactive maps using the `leaflet` package in R to visualize the gambling neighbourhoods identified using an hybrid approach combining HDBSCAN clustering specifically for Bristol. 
...
📝 **Note:** Results for MinPts=2 and 3 are not shown here as they produced very large clusters which are difficult to visualise and interpret on a map.
